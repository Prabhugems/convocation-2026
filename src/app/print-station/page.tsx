...
export default function PrintStationPage() {
  ...
  const downloadUrls = {
    mac: `https://github.com/${GITHUB_REPO}/releases/download/${LATEST_VERSION}/AMASI.Print.Station-1.0.4-arm64.dmg`,
    macIntel: `https://github.com/${GITHUB_REPO}/releases/download/${LATEST_VERSION}/AMASI.Print.Station-1.0.4.dmg`,
    windows: `https://github.com/${GITHUB_REPO}/releases/download/${LATEST_VERSION}/AMASI.Print.Station.Setup.1.0.4.exe`,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <footer className="border-t border-white/10 mt-12 py-8">
        <div className="max-w-4xl mx-auto px-6 text-center text-white/50 text-sm">
          AMASI Print Station v1.0.4 • AMASICON 2026 Convocation
        </div>
      </footer>
    </div>
  );
